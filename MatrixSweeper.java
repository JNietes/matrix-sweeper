...
public class MatrixSweeper {
      ...
      while (gameOn) {
         ...
         if (inputs[0].equals("f")) {
            ...
            if (topBoard[Integer.valueOf(inputs[1])][Integer.valueOf(inputs[0])] == ' ') {
               ...
               topBoard[Integer.valueOf(inputs[1])][Integer.valueOf(inputs[0])] = 'f';
            }
            else if (topBoard[Integer.valueOf(inputs[1])][Integer.valueOf(inputs[0])] == 'f') {
               if (heatmap[Integer.valueOf(inputs[1])][Integer.valueOf(inputs[0])] == 'X') {
                  minesFlagged--;
                  flagsLeft++;
               }   
               ...
               topBoard[Integer.valueOf(inputs[1])][Integer.valueOf(inputs[0])] = ' ';
            }
         ...
         if (topBoard[Integer.valueOf(inputs[1])][Integer.valueOf(inputs[0])] == ' ') {
            if (validCoordinate(topBoard, inputs) && digs == 0) {
               ...
               digHere(topBoard, heatmap, coolMatrix, Integer.valueOf(inputs[1]), Integer.valueOf(inputs[0]));
               digs++;  
            }
         }
         else
   ...
   public static boolean validCoordinate(char[][] mat, String[] array) {
      ...
      if (!onlyDigits(array[0]) || !onlyDigits(array[1])) {
         System.out.println("Digits only");
         return false;
      }
      if (!isValidSpace(mat, Integer.valueOf(array[0]), Integer.valueOf(array[1]))) {
   ...
   public static boolean isValidSpace(char[][] mat, int row, int column) {
      ...
      else if (column<0 || column>mat[row].length-1) {
         return false;
      }
      return true;
   }     
